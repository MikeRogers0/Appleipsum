    ...
    <form id="main" role="main">
    	...
    	<div id="lipsum_levels">
	    	<select name="lipsum_levels">
	    		...
	    		<option value="1" selected>2 Paragraphs</option>
	    		<option value="2">3 Paragraphs</option>
	    	</select>
    	</div>
    	</section>
    	<section id="controls">
